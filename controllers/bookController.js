...
exports.book_create_get = asyncHandler(async (req, res, next) => {
  ...
  res.render('partials/forms/book_form', {
    title: 'Create Book',
    authors: allAuthors,
    genres: allGenres,
    book: '',
...
exports.book_delete_get = asyncHandler(async (req, res, next) => {
  ...
  res.render('partials/book_delete', {
    title: 'Delete Book',
    book: book,
    book_instances: bookInstances,
  });
...
exports.book_delete_post = asyncHandler(async (req, res, next) => {
  ...
  if (bookInstances.length > 0) {
    // There are instances of the book. Render in  same way as for GET route.
    res.render('partials/book_delete', {
      title: 'Delete Book',
      book: book,
      book_instances: bookInstances,
    ...
    // There are no instances of the book. Delete object and redirect to the list of books.
